...
pluralCaseList.push( {plural: "orders/stores", pascal: "OrderStore"} )
pluralCaseList.push( {plural: "orders/orders", pascal: "OrderOrder"} )
pluralCaseList.push( {plural: "orders/payments", pascal: "OrderPayment"} )

pluralCaseList.push( {plural: "deliveries/deliveries", pascal: "DeliveryDelivery"} )
pluralCaseList.push( {plural: "deliveries/riders", pascal: "DeliveryRider"} )
