<template>
    <div>
        <BasePicker v-if="editMode" searchApiPath="customers" searchParameterName=""  idField="id" nameField="name" path="customers" label="CustomerId" v-model="value" @selected="pick" :editMode="editMode" />
