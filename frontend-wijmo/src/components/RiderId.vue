<template>
    <div>
        <BasePicker v-if="editMode" searchApiPath="riders" searchParameterName=""  idField="idid" :nameField="nameField":nameField="nameField" path="riders" label="RiderId" v-model="value" @selected="pick" :editMode="editMode" />
