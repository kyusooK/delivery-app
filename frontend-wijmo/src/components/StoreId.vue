<template>
    <div>
        <BasePicker v-if="editMode" searchApiPath="stores" searchParameterName=""  idField="id" nameField="name" path="stores" label="StoreId" v-model="value" @selected="pick" :editMode="editMode" />
